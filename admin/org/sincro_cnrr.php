...
<table cellspacing="1" cellpadding="5" class="tabla_consulta" width="600" align="center">
	<tr><td align='center' class='titulo_lista'>SINCRONIZACION DE ORGANIZACIONES :: SIDIH <-> CNRR</td></tr>
	<tr><td>&nbsp;</td></tr>
	<? 
	if (!isset($_POST["submit"])){
		echo '<tr><td><input type="radio" name="caso" value="1" onclick="chgURL(1)" '.$chk[1].'>Listar organizaciones que estan en SIDIH y que NO est&aacute;n en CNRR (La comparaci&oacute;n se hace por nombre y sigla, y se tienen en cuenta solo las organizaciones marcadas como CNRR)</td></tr>';
			  //<tr><td><input type="radio" name="caso" value="2" onclick="chgURL(2)" '.$chk[2].'>Listar organizaciones que estan en CNRR y que NO est&aacute;n en SIDIH</td></tr>
		echo ' <tr><td>';
