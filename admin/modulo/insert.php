			...
			<td>
			  <select name="id_papa" class="select">
				  <option value="0">No Aplica</option>
					<? $modulo_dao->ListarCombo('combo',$modulo_vo->id_papa,'ID_PAPA=0'); ?>						
				</select>
			</td>
		</tr>				
		<tr><td align="right">Nombre</td><td><input type="text" id="nombre" name="nombre" size="40" value="<?=$modulo_vo->nombre;?>" class="textfield" /></td></tr>
		<tr>
		  <td colspan="2" align='center'>
			  <br>
				<input type="hidden" name="accion" value="<?=$accion?>" />
			<input type="hidden" name="id" value="<?=$modulo_vo->id;?>" />									
