...
define('RELATIVE_PATH',$_SERVER["DOCUMENT_ROOT"].'/sissh/admin/lib/common/html2fpdf/');
define('FPDF_FONTPATH',$_SERVER["DOCUMENT_ROOT"].'/sissh/admin/lib/common/html2fpdf/font/');
