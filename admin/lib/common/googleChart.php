...
class gChart{
	 ...
	 *
	 * Please note that this function has an variable number of input variables. The order of the variable must be the following:
	 *	- axis index: The type of marker to use. Please refer to the documentation for usage.
	 *	- color: The color of the markers for this set, in RRGGBB hexadecimal format.
	 *	- font-size: in pixels.
     */
    public function setAxisLabelStyle() {
		$args = func_get_args();
		$this->setProperty('chxs', $this->encodeData($args, ','), true);
	}
