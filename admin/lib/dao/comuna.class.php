 ...
 * DAO de Comuna
 *
 * Contiene los métodos de la clase Comuna 
...
Class ComunaDAO {
	...
	function ComunaDAO (){
		...
		$this->tabla = "comuna";
		$this->columna_id = "ID_COMUNA";
		$this->columna_nombre = "NOM_COMUNA";
		$this->columna_order = "NOM_COMUNA";
	}

	/**
	 * Consulta los datos de una Comuna
	 * @access public
	 * @param int $id ID del Comuna
	 * @return VO
	 */	
	function Get($id){
	...
	/**
	 * Lista los Comuna que cumplen la condición en el formato dado
	 * @access public
	 * @param string $formato Formato en el que se listarán los Comuna, puede ser Tabla o ComboSelect
	 * @param int $valor_combo ID del Comuna que será selccionado cuando el formato es ComboSelect
	 * @param string $condicion Condición que deben cumplir los Comuna y que se agrega en el SQL statement.
	 */			
	...
	/**
	 * Lista los Comunas en una Tabla
	 * @access public
	 */			
	function ListarTabla($condicion){
		...
		$layout->adminGridLayout($arr,
								array('nombre' => array('titulo' => 'Nombre'), 'clase' => array('titulo' => 'Clase'), 'nacimiento' => array('titulo' => 'A&ntilde;o de creaci&oacute;n')),
	...
	/**
	 * Imprime en pantalla los datos del Comuna
	 * @access public
	 * @param object $vo Comuna que se va a imprimir
	 * @param string $formato Formato en el que se listarán los Comuna, puede ser Tabla o ComboSelect
	 * @param int $valor_combo ID del Comuna que será selccionado cuando el formato es ComboSelect
	 */			
	...
	/**
	 * Carga un VO de Comuna con los datos de la consulta
	 * @access public
	 * @param object $vo VO de Comuna que se va a recibir los datos
	 * @param object $Resultset Resource de la consulta
	 * @return object $vo VO de Comuna con los datos
	 */			
	...
	/**
	 * Inserta un Comuna en la B.D.
	 * @access public
	 * @param object $vo VO de Comuna que se va a insertar
	 */		
	function Insertar($vo){
		//CONSULTA SI YA EXISTE
		$cat_a = $this->GetAllArray($this->columna_nombre." = '".$vo->nombre."'");
		if (count($cat_a) == 0){
			$sql =  "INSERT INTO ".$this->tabla." (".$this->columna_id.",".$this->columna_nombre.",ID_MUN,ID_POB) VALUES ('".$vo->id."','".$vo->nombre."','".$vo->id_mun."','".$vo->id_pob."')";
