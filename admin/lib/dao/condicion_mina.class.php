 ...
 *
 * Contiene los métodos de la clase CondicionMina 
...
Class CondicionMinaDAO {
	...
	/**
	 * Lista los CondicionMina que cumplen la condición en el formato dado
	 * @access public
	 * @param string $formato Formato en el que se listarán los CondicionMina, puede ser Tabla o ComboSelect
	 * @param int $valor_combo ID del CondicionMina que será selccionado cuando el formato es ComboSelect
	 * @param string $condicion Condición que deben cumplir los CondicionMina y que se agrega en el SQL statement.
	 */			
