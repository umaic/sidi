 ...
 * DAO de Fuente
 *
 * Contiene los métodos de la clase Fuente 
...
Class FuenteDAO {
	...
	/**
	 * Lista los Fuente que cumplen la condición en el formato dado
	 * @access public
	 * @param string $formato Formato en el que se listarán los Fuente, puede ser Tabla o ComboSelect
	 * @param int $valor_combo ID del Fuente que será selccionado cuando el formato es ComboSelect
	 * @param string $condicion Condición que deben cumplir los Fuente y que se agrega en el SQL statement.
	 */			
