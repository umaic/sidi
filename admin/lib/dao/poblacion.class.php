 ...
 * DAO de Poblacion
 *
 * Contiene los métodos de la clase Poblacion
...
Class PoblacionDAO {
	...
	/**
	 * Lista los Poblacion que cumplen la condición en el formato dado
	 * @access public
	 * @param string $formato Formato en el que se listarán los Poblacion, puede ser Tabla o ComboSelect
	 * @param int $valor_combo ID del Poblacion que será selccionado cuando el formato es ComboSelect
	 * @param string $condicion Condición que deben cumplir los Poblacion y que se agrega en el SQL statement.
	 */
