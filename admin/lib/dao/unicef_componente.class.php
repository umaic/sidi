 ...
 * DAO de Componente
 *
 * Contiene los métodos de la clase Componente 
 * @author Ruben A. Rojas C.
 */

Class UnicefComponenteDAO {
	 ...
	 * @access public
	 */	
	function UnicefComponenteDAO (){
		$this->conn = MysqlDb::getInstance();
		$this->tabla = "unicef_componente";
		$this->columna_id = "id_componente";
		$this->columna_nombre = "nombre";
		$this->columna_order = "id_componente";
	}

	/**
	 * Consulta los datos de un Componente
	 * @access public
	...
	function Get($id){
		...
		//Crea un VO
		$subcat_vo = New UnicefComponente();
	...
	*/
	...
	/**
	 * Lista los Componente que cumplen la condición en el formato dado
	 * @access public
	 * @param string $formato Formato en el que se listarán los Componente, puede ser Tabla o ComboSelect
	 * @param int $valor_combo ID del Componente que será selccionado cuando el formato es ComboSelect
	 * @param string $condicion Condición que deben cumplir los Componente y que se agrega en el SQL statement.
	 */			
	...
	/**
	 * Carga un VO de Componente con los datos de la consulta
	 * @access public
	 * @param object $vo VO de Componente que se va a recibir los datos
	 * @param object $Resultset Resource de la consulta
	 * @return object $vo VO de Componente con los datos
	 */			
	...
	/**
	 * Inserta un Componente en la B.D.
	 * @access public
	 * @param object $subcat_vo VO de Componente que se va a insertar
	 */		
	...
	/**
	 * Actualiza un Componente en la B.D.
	 * @access public
	 * @param object $subcat_vo VO de Componente que se va a actualizar
	 */		
	...
	/**
	 * Borra un Componente en la B.D.
	 * @access public
	 * @param int $id ID del Componente que se va a borrar de la B.D
	 */	
	function Borrar($id){
