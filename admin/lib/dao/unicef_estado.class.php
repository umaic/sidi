 ...
 * DAO de Estado
 *
 * Contiene los métodos de la clase Estado 
 * @author Ruben A. Rojas C.
 */

Class UnicefEstadoDAO {
	 ...
	 * @access public
	 */	
	function UnicefEstadoDAO (){
		$this->conn = MysqlDb::getInstance();
		$this->tabla = "unicef_estado";
		$this->columna_id = "id_estado";
		$this->columna_nombre = "nombre";
		$this->columna_order = "nombre";
	}

	/**
	 * Consulta los datos de un Estado
	 * @access public
	...
	/**
	 * Lista los Estado que cumplen la condición en el formato dado
	 * @access public
	 * @param string $formato Formato en el que se listarán los Estado, puede ser Tabla o ComboSelect
	 * @param int $valor_combo ID del Estado que será selccionado cuando el formato es ComboSelect
	 * @param string $condicion Condición que deben cumplir los Estado y que se agrega en el SQL statement.
	 */			
	...
	/**
	 * Carga un VO de Estado con los datos de la consulta
	 * @access public
	 * @param object $vo VO de Estado que se va a recibir los datos
	 * @param object $Resultset Resource de la consulta
	 * @return object $vo VO de Estado con los datos
	 */			
	...
	/**
	 * Inserta un Estado en la B.D.
	 * @access public
	 * @param object $vo VO de Estado que se va a insertar
	 */		
	function Insertar($vo){
		//CONSULTA SI YA EXISTE
		$a = $this->GetAllArray($this->columna_nombre." = '".$vo->nombre."'");
		if (count($a) == 0){
			$sql =  "INSERT INTO ".$this->tabla." (".$this->columna_nombre.",VICT_SCATEVEN,ID_CATEVEN) VALUES ('".$vo->nombre."',$vo->info_vict,$vo->id_cat)";
	...
	/**
	 * Actualiza un Estado en la B.D.
	 * @access public
	 * @param object $vo VO de Estado que se va a actualizar
	 */		
	function Actualizar($vo){
		$sql =  "UPDATE ".$this->tabla." SET ";
		$sql .= $this->columna_nombre." = '".$vo->nombre."',";
		$sql .= " VICT_SCATEVEN = ".$vo->info_vict.",";
		$sql .= " ID_CATEVEN = ".$vo->id_cat;
	...
	/**
	 * Borra un Estado en la B.D.
	 * @access public
	 * @param int $id ID del Estado que se va a borrar de la B.D
	 */	
	function Borrar($id){
