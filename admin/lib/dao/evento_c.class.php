    ...
    */  
    function GraficaResumenEventoC($reporte,$num_records,$depto,$ubicacion,$f_ini,$f_fin,$chart,$filtros) {
        ...
        if ($reporte ==  1) {
                echo "<tr>
                        <td valign='top'>
                            <table border=0 class='tabla_grafica_conteo' width='250' cellspacing='1'>
                                <tr class='titulo_tabla_conteo'><td align='center' colspan='2'>Municipio</td><td align='center'>N&uacute;mero de eventos</td></tr>";
