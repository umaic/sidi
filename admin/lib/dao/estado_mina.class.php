 ...
 * DAO de EstadoMina
 *
 * Contiene los métodos de la clase EstadoMina 
...
Class EstadoMinaDAO {
	...
	/**
	 * Lista los EstadoMina que cumplen la condición en el formato dado
	 * @access public
	 * @param string $formato Formato en el que se listarán los EstadoMina, puede ser Tabla o ComboSelect
	 * @param int $valor_combo ID del EstadoMina que será selccionado cuando el formato es ComboSelect
	 * @param string $estado Condición que deben cumplir los EstadoMina y que se agrega en el SQL statement.
	 */			
