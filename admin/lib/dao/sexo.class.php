 ...
 * DAO de Sexo
 *
 * Contiene los métodos de la clase Sexo 
...
Class SexoDAO {
	...
	/**
	 * Lista los Sexo que cumplen la condición en el formato dado
	 * @access public
	 * @param string $formato Formato en el que se listarán los Sexo, puede ser Tabla o ComboSelect
	 * @param int $valor_combo ID del Sexo que será selccionado cuando el formato es ComboSelect
	 * @param string $condicion Condición que deben cumplir los Sexo y que se agrega en el SQL statement.
	 */			
