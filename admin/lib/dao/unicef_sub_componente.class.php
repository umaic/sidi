 ...
 *
 * Contiene los métodos de la clase SubComponente 
...
Class UnicefSubComponenteDAO {
	...
	*/
	...
	/**
	 * Lista los SubComponente que cumplen la condición en el formato dado
	 * @access public
	 * @param string $formato Formato en el que se listarán los SubComponente, puede ser Tabla o ComboSelect
	 * @param int $valor_combo ID del SubComponente que será selccionado cuando el formato es ComboSelect
	 * @param string $condicion Condición que deben cumplir los SubComponente y que se agrega en el SQL statement.
	 */			
