 ...
 * DAO de Moneda
 *
 * Contiene los métodos de la clase Moneda 
...
Class MonedaDAO {
	...
	/**
	 * Lista los Moneda que cumplen la condición en el formato dado
	 * @access public
	 * @param string $formato Formato en el que se listarán los Moneda, puede ser Tabla o ComboSelect
	 * @param int $valor_combo ID del Moneda que será selccionado cuando el formato es ComboSelect
	 * @param string $condicion Condición que deben cumplir los Moneda y que se agrega en el SQL statement.
	 */			
