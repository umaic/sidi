 ...
 * DAO de Socio
 *
 * Contiene los métodos de la clase Socio 
 * @author Ruben A. Rojas C.
 */

Class UnicefSocioDAO {
	 ...
	 * @access public
	 */	
	function UnicefSocioDAO (){
		$this->conn = MysqlDb::getInstance();
		$this->tabla = "unicef_socio";
		$this->columna_id = "id_socio";
	...
	*/
	...
	/**
	 * Lista los Socio que cumplen la condición en el formato dado
	 * @access public
	 * @param string $formato Formato en el que se listarán los Socio, puede ser Tabla o ComboSelect
	 * @param int $valor_combo ID del Socio que será selccionado cuando el formato es ComboSelect
	 * @param string $condicion Condición que deben cumplir los Socio y que se agrega en el SQL statement.
	 */			
	...
	/**
	 * Carga un VO de Socio con los datos de la consulta
	 * @access public
	 * @param object $vo VO de Socio que se va a recibir los datos
	 * @param object $Resultset Resource de la consulta
	 * @return object $vo VO de Socio con los datos
	 */			
	...
	/**
	 * Inserta un Socio en la B.D.
	 * @access public
	 * @param object $vo VO de Socio que se va a insertar
	 */		
	...
	/**
	 * Actualiza un Socio en la B.D.
	 * @access public
	 * @param object $vo VO de Socio que se va a actualizar
	 */		
	...
	/**
	 * Borra un Socio en la B.D.
	 * @access public
	 * @param int $id ID del Socio que se va a borrar de la B.D
	 */	
	function Borrar($id){
	...
	function checkForeignKeys($id){
		...
		$tabla_rel = 'unicef_producto_awp_socio';
