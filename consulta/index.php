...
<tr>
	...
	if (in_array(15,$perfil->id_modulo)){
		...
		<td valign='top'>
			<table id="td_org" cellspacing='0' cellpadding='10' border="0" class="home_consulta">
				...
				<tr>
					<td colspan=2>
						Este módulo le permite realizar consultas de Organizaciones por:
						<br><br>
						&raquo;&nbsp; Tipo&nbsp;&raquo;&nbsp; Sector&nbsp;&raquo;&nbsp; Enfoque<br>
						&raquo;&nbsp; Población&nbsp;&raquo;&nbsp; Cobertura Geográfica
					</td>
				</tr>
			</table>
		</td>
	...
	<td valign='top'>
		<table id="td_org" cellspacing='0' cellpadding='10' border="0" class="home_consulta">
			...
			<tr>
				<td colspan=2>
					Este módulo le permite realizar consultas de Desplazamiento por:
					<br><br>
	...
	if (in_array(18,$perfil->id_modulo)){
		...
		<td valign='top'>
			<table id="td_org" cellspacing='0' cellpadding='10' border="0" class="home_consulta">
				...
				<tr>
					<td colspan=2>
						Este módulo le permite realizar consultas de Datos Sectoriales por:
						&raquo;&nbsp; Categoría&nbsp;&raquo;&nbsp; Cobertura Geográfica
						<br><br>
	...
	<td valign='top'>
		<table cellspacing='1' cellpadding='3' class='tabla_consulta' width='237' height="250">
			...
			<tr>
				<td>
				Este módulo le permite realizar consultas de Eventos por:<br><br>
				- Tipo <br>
				- Actor <br>
	...
	if (in_array(31,$perfil->id_modulo)){	 
		...
		<td valign='top'>
			<table id="td_org" cellspacing='0' cellpadding='10' border="0" class="home_consulta">
				...
				<tr>
					<td colspan=2>
						Este módulo le permite realizar consultas de Eventos por:
						<br><br>
			...
			<tr>
				<td id="td_mina" valign="top">
					<table cellpadding="3" cellspacing="3" class="home_consulta"  height="202">
						<tr>
							<td align='left'>
							Este módulo le permite consultar Eventos con Mina por:<br><br>
							&raquo;&nbsp; Tipo de Evento<br>
							&raquo;&nbsp; Condición <br>
							&raquo;&nbsp; Estado <br>
							&raquo;&nbsp; Edad  <br>
							&raquo;&nbsp; Sexo  <br>
							&raquo;&nbsp; Ubicación Geográfica
							</td>
						</tr>
					</table>
				</td>
	...
	if (in_array(16,$perfil->id_modulo)){
		...
		<!--<td valign='top'>
			<table id="td_org" cellspacing='0' cellpadding='10' border="0" class="home_consulta">
				...
				<tr>
					<td colspan=2>
						Este módulo le permite realizar consultas de Proyectos por:
						<br><br>
  ...
  <!--<tr>
	<td valign='top' colspan="2">
		<table cellspacing='1' cellpadding='3' class='tabla_consulta' width='300'>
			...
			<tr>
				<td><p align="justify">
				Este módulo le permite realizar consultas de Organizaciones, Proyectos o Eventos por Departamento o Municipio
				</p></td></tr>
		</table>
	</td>
</tr>-->
