...
switch ($method){
		...
		<table cellspacing="1" cellpadding="5" class="tabla_consulta" width="940" align="center">
			...
			<tr>
				<td>
					...
					<img src="images/flecha.gif">&nbsp;<a href="javascript:showDiv('mapa','mostrar');"><b>Filtrar por Ubicación Geográfica</b></a>
	...
	case 'graficaConteoDeptoMpio':
		...
		<table cellspacing="1" cellpadding="5" class="tabla_consulta" width="940" align="center">
			...
			<tr>
				<td>
					<img src="images/flecha.gif">&nbsp;<a href="javascript:showDiv('mapa','mostrar');"><b>Ubicación Geográfica</b></a>
					<span id="texto_ubicacion">Cargando Flash....</span>&nbsp;&nbsp;
