			...
			<tr>
				<td valign="top">
					<table cellspacing="0">
						...
						<tr>
							...
							<td class="titulo_filtro">&nbsp;<img src="images/gra_resumen/fl_filtro.gif">&nbsp;Población</td>
						</tr>
						<tr>
							<td id="td_enfoque">
				...
				<td valign="top">
					<table width="100%" border="0">
						<tr><td colspan="2" class="titulo_filtro" width="410">&nbsp;<img src="images/gra_resumen/fl_filtro.gif">&nbsp;Ubicación Geográfica</td></tr>
