...
Class EventoDAO {
  ...
  */	
	...
	/**
  * Consulta los datos de los Evento que cumplen una condición
  * @access public
	...
	*/		
	function ActualizarCobertura($evento_vo,$paso){
		...
		if ($paso == 2){
			?>
			<script>
			alert("Cobertura Geográfica (Poblado - Región) registrada con exito!");
			</script>
			<?
		}
		if ($paso == 3){
			?>
			<script>
			alert("Cobertura Geográfica (Departamento - Municipio) registrada con éxito!");
			location.href = '<?=$this->url;?>';
			</script>
			<?
		}
			...
			?>
			<script>
			alert("Cobertura Geográfica (Parque Natural, Resguardo o Divison Afro) registrada con éxito!");
			location.href = '<?=$this->url;?>';
			</script>
			<?
		}
			...
			?>
			<script>
			alert("Cobertura Geográfica (Poblado - Región) registrada con éxito!");
			location.href = '<?=$this->url;?>';
			</script>
			<?
		}
