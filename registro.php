...
function validar(){
	...
	if (validar_forma('nombre,Nombre Completos,org,Organización,tel,Teléfono,email,Email,punto_contacto,Punto de contácto en OCHA,login,Nombre de Usuario,pass,Contraseña,security_code,Código de Seguridad',document.getElementById('email').value)){
